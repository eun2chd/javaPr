package _10_Collection._list._set;
...
public class HashSetEx {
	public static void main(String[] args) {
		...
		Course js2 = new Course("JavaScript", 103);
		...
		// case 2 iterator() 메서드로 반복자를 얻어 객체 하니씩 가져오기
		...
		java.util.Iterator<Course> iterator = set2.iterator();
